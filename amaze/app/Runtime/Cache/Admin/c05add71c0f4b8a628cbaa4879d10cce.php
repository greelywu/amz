  ...
  <div class="am-container">
    ...
    <div class="am-collapse am-topbar-collapse" id="collapse-head">
      <ul class="am-nav am-nav-pills am-topbar-nav">
		...
		<li class="am-active"><a href="#">数据编辑</a></li>
      </ul>
	...
	<?php else: ?>
		<div  class="am-topbar-right" style="color:white">
...
<div class="am-container">
<FORM method="post" action="/index.php/admin/index/update_row" class="am-form" data-am-validator>
 <INPUT type="hidden" name="id" value="<?php echo ($result["id"]); ?>"/><INPUT type="hidden" name="p" value="<?php echo ($haha); ?>"/>
<div class="am-form-group"><INPUT type="text" name="title" placeholder="输入标题（至少 3 个字符）" required value="<?php echo ($result["title"]); ?>" /></div>
...
<button class="am-btn am-btn-danger" type="reset">重置</button><button class="am-btn am-btn-secondary" type="submit">提交</button><button class="am-btn am-btn-primary" onclick="window.location.href='/index.php/admin/index/..'" type="none">返回</button>
  ...
  <footer data-am-widget="footer"
    ...
    <div class="am-footer-miscs ">
        ...
        <p>laibaogo.com&copy2015 | ICP备</p>
...
<script type="text/javascript">
    //实例化编辑器
	 $(function() {
    var um = UM.getEditor('myEditor',{UMEDITOR_HOME_URL: "/Public/umeditor/",autoClearinitialContent: false,textarea: 'content', imageUrl: "<?php echo U('Index/upload');?>",              
  imagePath: ""});});
	</script>
